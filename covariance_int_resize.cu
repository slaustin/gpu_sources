...
int main ()
{
  int blocks,threads,line_num,frame,i,k,j,x,y,z,points,grid_point,min_x,min_y,min_z,max_x,max_y,max_z,max_frame,line_counter,avg_only,print_flg,all_points,test_sum,pare,count;
